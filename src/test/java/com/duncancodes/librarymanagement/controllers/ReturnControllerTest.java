...
public class ReturnControllerTest {
	...
	@Test
	public void testReturnBook() throws RecordNotFoundException {
		when(borrowService.returnBook(1L, isbn)).thenReturn("Success");
		ResponseEntity<String> response = returnController.returnBook(1L, isbn);
